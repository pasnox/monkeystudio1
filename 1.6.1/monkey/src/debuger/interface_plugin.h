...
#define DEBUGGER_BEFORT_START		DEBUGGER_BASE_ADDR+6
...
#define PLUGIN_TO_EDITOR		PLUGIN_BASE_ADDR+7	
...
public:
	...
	virtual QPointer <QWidget > pluginGetWidget()=0;		// return pointer of your widget contener
	virtual void pluginInitWidget()=0;			// init your widget (clear, add row, ....)
	virtual void pluginGdbStarted(bool)=0;

	virtual QDialog * pluginSetting()=0;
