...
private :
	...
	// retourne l'item qui suit celui en cours
	...
	QString memberCount;
 	int indexMemberCount;
 	int indexTranslateQStringList;
 	QString tmpQStringList;
...
int getTranslate(struct UIdebugger_struct *debugger_struct);
	...
	// QString
	QString translateQString(struct UIdebugger_struct * debugger_struct, QString variableName);

	// QList
	QString translateQList(struct UIdebugger_struct * debugger_struct,QString Type, QString variableName);

	// QStringList ou QList<QString>
	QString translateQStringList(struct UIdebugger_struct * debugger_struct, QString variableName);
